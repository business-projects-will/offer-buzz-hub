  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden px-4 pt-16 pb-12 sm:px-6 sm:pt-24 sm:pb-16">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute top-40 -right-40 h-100 w-100 rounded-full bg-neon-cyan/10 blur-[120px]"
        />
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="font-display mt-6 text-3xl leading-[1.08] font-bold tracking-tight min-[380px]:text-4xl sm:text-6xl sm:leading-[1.05]">
            ...
            <span className="text-neon-cyan text-glow-neon-cyan">celular</span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Curadoria diária de promoções, cupons exclusivos e bugs de preço — enviados em tempo
            real para o nosso grupo de WhatsApp. Entre grátis e nunca mais pague o preço cheio.
          </p>
        </div>
      </section>

      {/* WHATSAPP */}
      <section className="px-4 pb-16 sm:px-6" aria-label="Grupo de ofertas no WhatsApp">
      ...
      <section className="px-4 pb-20 sm:px-6" aria-label="Benefícios">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-sm text-muted-foreground">
            Um portal híbrido: navegue pelas ofertas no site e receba os alertas mais quentes no
            WhatsApp.
          </p>
